...
export default function Create() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('data-kependudukan.persebaran-penduduk.store'), {
            onSuccess: () => {
                toast.success("Berhasil", {
                    description: "Data persebaran penduduk berhasil ditambahkan.",
                });
            },
            onError: (errors) => {
                toast.error("Gagal", {
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: 'Tambah Data', href: route('data-kependudukan.persebaran-penduduk.create') },
        ]}>
            <Head title="Tambah Data Persebaran Penduduk" />
            ...
            <div className="p-4 md:p-6 space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-xl md:text-2xl font-semibold">Tambah Data Persebaran Penduduk</h2>
                </div>
